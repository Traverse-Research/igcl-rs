...
pub enum _ctl_3d_feature_misc_flag_t {
    ...
    CTL_3D_FEATURE_MISC_FLAG_DX9 = 1,
    #[doc = "< Feature supported on DX11"]
    CTL_3D_FEATURE_MISC_FLAG_DX11 = 2,
    #[doc = "< Feature supported on DX12"]
    CTL_3D_FEATURE_MISC_FLAG_DX12 = 4,
    #[doc = "< Feature supported on VULKAN"]
    CTL_3D_FEATURE_MISC_FLAG_VULKAN = 8,
    #[doc = "< User can change feature live without restarting the game"]
    CTL_3D_FEATURE_MISC_FLAG_LIVE_CHANGE = 16,
...
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum _ctl_3d_low_latency_types_t {
    ...
    CTL_3D_LOW_LATENCY_TYPES_MAX = 3,
}
#[doc = "\n @brief Low latency mode values possible"]
...
#[non_exhaustive]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum _ctl_firmware_config_flag_t {
    ...
    CTL_FIRMWARE_CONFIG_FLAG_IS_DEVICE_LINK_SPEED_DOWNGRADE_CAPABLE = 1,
    ...
    CTL_FIRMWARE_CONFIG_FLAG_IS_DEVICE_LINK_SPEED_DOWNGRADE_ACTIVE = 2,
...
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum _ctl_vf_curve_details_t {
...
pub struct ControlLib {
    ...
    pub ctlEccGetProperties: unsafe extern "C" fn(
        hDAhandle: ctl_device_adapter_handle_t,
        pProperties: *mut ctl_ecc_properties_t,
    ) -> ctl_result_t,
    pub ctlEccGetState: unsafe extern "C" fn(
        hDAhandle: ctl_device_adapter_handle_t,
        pState: *mut ctl_ecc_state_desc_t,
    ) -> ctl_result_t,
    pub ctlEccSetState: unsafe extern "C" fn(
        hDAhandle: ctl_device_adapter_handle_t,
        pState: *mut ctl_ecc_state_desc_t,
    ) -> ctl_result_t,
    ...
    pub ctlGetFirmwareProperties: unsafe extern "C" fn(
        hDeviceAdapter: ctl_device_adapter_handle_t,
        pProperties: *mut ctl_firmware_properties_t,
    ) -> ctl_result_t,
    pub ctlEnumerateFirmwareComponents: unsafe extern "C" fn(
        hDeviceAdapter: ctl_device_adapter_handle_t,
        pCount: *mut u32,
        phFirmware: *mut ctl_firmware_component_handle_t,
    ) -> ctl_result_t,
    pub ctlGetFirmwareComponentProperties: unsafe extern "C" fn(
        hFirmware: ctl_firmware_component_handle_t,
        pProperties: *mut ctl_firmware_component_properties_t,
    ) -> ctl_result_t,
    pub ctlAllowPCIeLinkSpeedUpdate: unsafe extern "C" fn(
        hDeviceAdapter: ctl_device_adapter_handle_t,
    ...
    pub ctlEnumLeds: unsafe extern "C" fn(
        hDAhandle: ctl_device_adapter_handle_t,
        pCount: *mut u32,
        phLed: *mut ctl_led_handle_t,
    ) -> ctl_result_t,
    pub ctlLedGetProperties: unsafe extern "C" fn(
    ...
    pub ctlLedSetState: unsafe extern "C" fn(
        hLed: ctl_led_handle_t,
    ...
    pub ctlOverclockResetToDefault:
        unsafe extern "C" fn(hDeviceHandle: ctl_device_adapter_handle_t) -> ctl_result_t,
    pub ctlOverclockGpuFrequencyOffsetGetV2: unsafe extern "C" fn(
        hDeviceHandle: ctl_device_adapter_handle_t,
        pOcFrequencyOffset: *mut f64,
    ) -> ctl_result_t,
    pub ctlOverclockGpuFrequencyOffsetSetV2: unsafe extern "C" fn(
        hDeviceHandle: ctl_device_adapter_handle_t,
        ocFrequencyOffset: f64,
    ) -> ctl_result_t,
    pub ctlOverclockGpuMaxVoltageOffsetGetV2: unsafe extern "C" fn(
        hDeviceHandle: ctl_device_adapter_handle_t,
        pOcMaxVoltageOffset: *mut f64,
    ) -> ctl_result_t,
    pub ctlOverclockGpuMaxVoltageOffsetSetV2: unsafe extern "C" fn(
        hDeviceHandle: ctl_device_adapter_handle_t,
        ocMaxVoltageOffset: f64,
    ) -> ctl_result_t,
    pub ctlOverclockVramMemSpeedLimitGetV2: unsafe extern "C" fn(
        hDeviceHandle: ctl_device_adapter_handle_t,
        pOcVramMemSpeedLimit: *mut f64,
    ) -> ctl_result_t,
    pub ctlOverclockVramMemSpeedLimitSetV2: unsafe extern "C" fn(
        hDeviceHandle: ctl_device_adapter_handle_t,
        ocVramMemSpeedLimit: f64,
    ) -> ctl_result_t,
    pub ctlOverclockPowerLimitGetV2: unsafe extern "C" fn(
        hDeviceHandle: ctl_device_adapter_handle_t,
        pSustainedPowerLimit: *mut f64,
    ) -> ctl_result_t,
    pub ctlOverclockPowerLimitSetV2: unsafe extern "C" fn(
        hDeviceHandle: ctl_device_adapter_handle_t,
        sustainedPowerLimit: f64,
    ) -> ctl_result_t,
    pub ctlOverclockTemperatureLimitGetV2: unsafe extern "C" fn(
        hDeviceHandle: ctl_device_adapter_handle_t,
        pTemperatureLimit: *mut f64,
    ) -> ctl_result_t,
    pub ctlOverclockTemperatureLimitSetV2: unsafe extern "C" fn(
        hDeviceHandle: ctl_device_adapter_handle_t,
        temperatureLimit: f64,
    ) -> ctl_result_t,
    pub ctlOverclockReadVFCurve: unsafe extern "C" fn(
        hDeviceAdapter: ctl_device_adapter_handle_t,
    ...
    pub ctlOverclockWriteCustomVFCurve: unsafe extern "C" fn(
        hDeviceAdapter: ctl_device_adapter_handle_t,
        NumPoints: u32,
...
impl ControlLib {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let ctlGetFirmwareProperties = __library
            .get(b"ctlGetFirmwareProperties\0")
            .map(|sym| *sym)?;
        ...
        let ctlOverclockTemperatureLimitSetV2 = __library
            ...
            .map(|sym| *sym)?;
        let ctlOverclockReadVFCurve = __library
            .get(b"ctlOverclockReadVFCurve\0")
            .map(|sym| *sym)?;
    ...
    pub unsafe fn ctlEccGetProperties(
        ...
        (self.ctlEccGetProperties)(hDAhandle, pProperties)
    }
    ...
    pub unsafe fn ctlEccGetState(
        ...
        (self.ctlEccGetState)(hDAhandle, pState)
    }
    ...
    pub unsafe fn ctlEccSetState(
        ...
        (self.ctlEccSetState)(hDAhandle, pState)
    }
    ...
    pub unsafe fn ctlGetFirmwareProperties(
        ...
        (self.ctlGetFirmwareProperties)(hDeviceAdapter, pProperties)
    }
    ...
    pub unsafe fn ctlEnumerateFirmwareComponents(
        ...
        (self.ctlEnumerateFirmwareComponents)(hDeviceAdapter, pCount, phFirmware)
    }
    ...
    pub unsafe fn ctlGetFirmwareComponentProperties(
        ...
        (self.ctlGetFirmwareComponentProperties)(hFirmware, pProperties)
    }
    ...
    pub unsafe fn ctlAllowPCIeLinkSpeedUpdate(
        ...
        (self.ctlAllowPCIeLinkSpeedUpdate)(hDeviceAdapter, AllowPCIeLinkSpeedUpdate)
    }
    ...
    pub unsafe fn ctlEnumLeds(
        ...
        (self.ctlEnumLeds)(hDAhandle, pCount, phLed)
    }
    ...
    pub unsafe fn ctlLedGetProperties(
        ...
        (self.ctlLedGetProperties)(hLed, pProperties)
    }
    #[doc = "\n @brief Get Led state\n\n @details\n     - The application may call this function from simultaneous threads.\n     - The implementation of this function should be lock-free.\n\n @returns\n     - CTL_RESULT_SUCCESS\n     - CTL_RESULT_ERROR_UNINITIALIZED\n     - CTL_RESULT_ERROR_DEVICE_LOST\n     - CTL_RESULT_ERROR_INVALID_NULL_HANDLE\n         + `nullptr == hLed`\n     - CTL_RESULT_ERROR_INVALID_NULL_POINTER\n         + `nullptr == pState`"]
    pub unsafe fn ctlLedGetState(
        ...
        (self.ctlLedGetState)(hLed, pState)
    }
    ...
    pub unsafe fn ctlLedSetState(
        ...
        (self.ctlLedSetState)(hLed, pBuffer, bufferSize)
    }
    ...
    pub unsafe fn ctlOverclockGpuFrequencyOffsetGetV2(
        ...
        (self.ctlOverclockGpuFrequencyOffsetGetV2)(hDeviceHandle, pOcFrequencyOffset)
    }
    ...
    pub unsafe fn ctlOverclockGpuFrequencyOffsetSetV2(
        ...
        (self.ctlOverclockGpuFrequencyOffsetSetV2)(hDeviceHandle, ocFrequencyOffset)
    }
    ...
    pub unsafe fn ctlOverclockGpuMaxVoltageOffsetGetV2(
        ...
        (self.ctlOverclockGpuMaxVoltageOffsetGetV2)(hDeviceHandle, pOcMaxVoltageOffset)
    }
    ...
    pub unsafe fn ctlOverclockGpuMaxVoltageOffsetSetV2(
        ...
        (self.ctlOverclockGpuMaxVoltageOffsetSetV2)(hDeviceHandle, ocMaxVoltageOffset)
    }
    ...
    pub unsafe fn ctlOverclockVramMemSpeedLimitGetV2(
        ...
        (self.ctlOverclockVramMemSpeedLimitGetV2)(hDeviceHandle, pOcVramMemSpeedLimit)
    }
    ...
    pub unsafe fn ctlOverclockVramMemSpeedLimitSetV2(
        ...
        (self.ctlOverclockVramMemSpeedLimitSetV2)(hDeviceHandle, ocVramMemSpeedLimit)
    }
    ...
    pub unsafe fn ctlOverclockPowerLimitGetV2(
        ...
        (self.ctlOverclockPowerLimitGetV2)(hDeviceHandle, pSustainedPowerLimit)
    }
    ...
    pub unsafe fn ctlOverclockPowerLimitSetV2(
        ...
        (self.ctlOverclockPowerLimitSetV2)(hDeviceHandle, sustainedPowerLimit)
    }
    ...
    pub unsafe fn ctlOverclockTemperatureLimitGetV2(
        ...
        (self.ctlOverclockTemperatureLimitGetV2)(hDeviceHandle, pTemperatureLimit)
    }
    ...
    pub unsafe fn ctlOverclockTemperatureLimitSetV2(
        ...
        (self.ctlOverclockTemperatureLimitSetV2)(hDeviceHandle, temperatureLimit)
    }
    ...
    pub unsafe fn ctlOverclockWriteCustomVFCurve(
        ...
        (self.ctlOverclockWriteCustomVFCurve)(hDeviceAdapter, NumPoints, pCustomVFCurveTable)
    }
